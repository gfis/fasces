...
*/
			function world( scene, myfont ) {
				...
				var thick  = parseInt(size5 / 5); // thickness of the cylinders
				...
				var shift = (size5 - thick) * 0.5 - 2.5;
				for ( i = 0; i < points.length - 1; i ++ ) {
					var geometry = new THREE.CylinderGeometry( thick, thick, size5, corner );
							// reduce the 1st parameter a bit to see the direction
					geometry.rotateY(Math.PI / corner); // square and not diamond
					...
					color3.setHSL( i * 0.85 / points.length, 1.0, 0.5 );
