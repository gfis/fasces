 ...
 *  usage:
 *    java NegPos rule s noeis n op a1 d1
 *        rule  = 1|2|3
 *        s     = 0|1
    ...
    protected int next() {
        ...
        switch (mVariant) {
            ...
            case 2: // dk
                ...
                break;
            default:
                System.err.println("variant \"" + mVariant + "\" not implemented");
                return result;
        } // switch mVariant
        ...
        while (mK <= mNoTerms) {
            ...
            switch (mVariant) {
                case 1: // mAk
                    System.out.println(mK + " " + mAk);
                    break;
                case 2: // dk
                    System.out.println(mK + " " + mDk);
                    break;
            } // switch mVariant
            mAk_1 = mAk;
            mDk_1 = mDk;
